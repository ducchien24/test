...
import classes from './PasswordInputCustom.module.css';
...
export const PasswordInputCustom = factory<PasswordInputFactory>((_props, ref) => {
...
PasswordInputCustom.classes = { ...InputBase.classes, ...classes };
PasswordInputCustom.displayName = '@mantine/core/PasswordInput';
